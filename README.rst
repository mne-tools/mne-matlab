...
This is a collection of MATLAB files to process MEG and EEG data.
These files allow a nice interaction with the other MNE projects, including:

- `MNE-C <https://mne.tools/stable/install/mne_c.html#install-mne-c>`_
