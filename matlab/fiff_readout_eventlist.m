function eventlist = fiff_readout_eventlist(fname, stim_chennal, consecutive, output)
%	Find event from raw file
%	
%	Parameters
%	----------
%	fname : String, .fiff raw data file name
%	stim_chennal : the channel that record event
...
%	Returns
%	-------
%	    eventlist : array, shape = (n_events, 3)
...
%			 Chien-Chung Chen / Visual Neuroscience Lab, NTU
%	Date: 2017,9,16
%	License: BSD (3-clause)

raw = fiff_setup_read_raw(fname);
[data, times] = fiff_read_raw_segment(raw);
pick = stim_chennal; % stim_chennal
